...
Python wrapper for Utah school enrollment data.

This is a thin rpy2 wrapper around the [utschooldata](https://github.com/almartin82/utschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `utschooldata` R package installed
...
# In R:
# remotes::install_github("almartin82/utschooldata")

# Then install the Python package
pip install pyutschooldata
```
...
# Fetch one year
df = ut.fetch_enr(2025)

# Fetch multiple years
df_multi = ut.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
