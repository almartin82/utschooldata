...
Utah has one of the youngest populations in America and keeps adding
students while most states shrink–but dig into the district-level data
and the story gets complicated fast. Salt Lake City is hemorrhaging
enrollment, charter schools serve nearly 1 in 4 students, and Hispanic
enrollment has surged 46% in a decade.
...
**[Full documentation](https://almartin82.github.io/utschooldata/)** –
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#salt-lake-city-district-lost-17-of-students-since-2019)

### 2. Charter schools serve a growing share of Utah students

Utah has a robust charter school sector, with nearly 25% of public
school students attending charter schools–one of the highest rates in
the nation.
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#charter-schools-serve-a-growing-share-of-utah-students)
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#hispanic-enrollment-grew-46-since-2014)

## Data Taxonomy

| Category           | Years     | Function                                                                                                                                                                          | Details                                                     |
|--------------------|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|
| **Enrollment**     | 2014-2026 | [`fetch_enr()`](https://almartin82.github.io/utschooldata/reference/fetch_enr.md) / [`fetch_enr_multi()`](https://almartin82.github.io/utschooldata/reference/fetch_enr_multi.md) | State, district, school. Race, gender, FRPL, SpEd, LEP      |
| Assessments        | –         | –                                                                                                                                                                                 | Not yet available                                           |
| Graduation         | –         | –                                                                                                                                                                                 | Not yet available                                           |
| **Directory**      | Current   | [`fetch_directory()`](https://almartin82.github.io/utschooldata/reference/fetch_directory.md)                                                                                     | District, school. Principal, superintendent, address, phone |
...
> taxonomy](https://almartin82.github.io/utschooldata/DATA-CATEGORY-TAXONOMY.md)
...
trends](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html)
– 15 stories - [Function
reference](https://almartin82.github.io/utschooldata/reference/)
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#utahs-enrollment-continues-to-grow)

### 5. Granite and Alpine are Utah’s enrollment giants

Utah’s two largest districts–Granite and Alpine–each serve well over
57,000 students, but their trajectories differ. Salt Lake City has seen
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#granite-and-alpine-are-utahs-enrollment-giants)
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#utahs-student-body-is-diversifying)
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#pacific-islander-students-are-a-unique-utah-story)
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#utah-county-is-the-growth-engine)
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#rural-districts-face-decline)
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#washington-county-is-utahs-fastest-growing-region)
...
relatively quickly after COVID disruptions, though it has since declined
further.
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#kindergarten-enrollment-dipped-during-covid-but-recovered)

### 12. High school enrollment is surging

As larger elementary cohorts from the 2010s move through the system,
Utah high schools are seeing significant enrollment growth–up 25% since
2014.
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#high-school-enrollment-is-surging)
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#english-learner-population-nearly-doubled)
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#nearly-1-in-3-students-are-economically-disadvantaged)
...
[(source)](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html#elementary-enrollment-is-declining-while-high-school-grows)
