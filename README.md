...
Utah has one of the youngest populations in America and keeps adding students while most states shrink--but dig into the district-level data and the story gets complicated fast. Salt Lake City is hemorrhaging enrollment, charter schools serve nearly 1 in 4 students, and Hispanic enrollment has surged 46% in a decade.
...
**[Full documentation](https://almartin82.github.io/utschooldata/)** -- all 15 stories with interactive charts, getting-started guide, and complete function reference.
...
- [Enrollment trends](https://almartin82.github.io/utschooldata/articles/enrollment_hooks.html) -- 15 stories
- [Function reference](https://almartin82.github.io/utschooldata/reference/)
